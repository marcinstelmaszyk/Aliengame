...
class Scoreboard():
    ...
    def prep_high_score(self):
        ...
        # Wyświetlenie najlepszego wyniku w grze na śodku ekranu, przy górnej krawędzi
        self.high_score_rect = self.high_score_image.get_rect()
        self.high_score_rect.centerx = self.screen_rect.centerx
        self.high_score_rect.top = self.score_rect.top

    def prep_level(self):
        '''Konwersja numeru poziomu na wynenerowany obraz.'''
    ...
    def prep_ships(self):
        '''Wyświetla liczbę statkó, jakie pozostały graczowi.'''
        self.ships = Group()
